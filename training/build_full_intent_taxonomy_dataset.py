...
ROW_SPECS = (
    ...
    },
    {
        ...
        "templates": (
            ...
            "give me a shortlist of {products} for {domain}",
            "what are some promising {products} for {goal}",
            "where should I start exploring {products} for {domain}",
            "show me categories of {products} worth researching",
            "what {products} should be on my radar for {domain}",
        ),
    },
    {
